...
<div class="content">
    <div class="content byEditor">
        ...
        <h3><a href = "http://images.is.ed.ac.uk/luna/servlet/view/search?search=Search&q=World+History" target = "_blank" title = "Hi-res Rashid images" alt = "hi-res Rashid images"><span class="icon media-artwork"></span>High resolution images</a> of all of the pages in the LUNA imaging platform.</h3>

        <h3>
            <a href = "http://images.is.ed.ac.uk/luna/servlet/s/kwl89a" target = "_blank"  title = "World History book reader" alt = "World History book reader"><span class="icon media-book"></span>The full book</a>, using LUNA's page-turning software.
       </h3>
        <h3>
            <a href = "http://vimeo.com/103231632" target = "_blank"  title = "Rashid al-din Exhibition Installation" alt = "Rashid al-din Exhibition Installation"><span class="icon media-video"></span>The time lapse film</a> by the Digital Imaging Unit of the Exhibition installation on Vimeo.
        </h3>
    </div>
</div>