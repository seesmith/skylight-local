...
$config['skylight_url_prefixes'] = array('mimed', 'art', 'calendars', 'iconics', 'towardsdolly', 'alumni', 'stcecilia', 'dott');

$config['skylight_handle_prefixes'] = array(3 => "art", 11 => "mimed");

// The URL of the parent solr server
$config['skylight_solrbase'] = 'http://localhost:9124/solr/search/';
...
$config['skylight_oaipmhbase'] = 'http://localhost:9124/oai/request?';
...
$config['skylight_objectproxy_url'] = 'http://localhost:9124/bitstream/10683/';
