<?php
    ...
    $config['skylight_repository_version'] = '181'; // default '171'
    ...
    $config['skylight_oaipmhbase'] = 'http://localhost:8081/xmlui/oai/request?';

    // The OAI-PMH identifier to replace in OAI-PMH responses
    $config['skylight_oaipmhid']= 'http://localhost:8081/xmlui/bitstream/handle/123456789/';
