...
$config['skylight_appname'] = 'rocks';

$config['skylight_theme'] = 'rocks';

$config['skylight_fullname'] = 'Cockburn Museum Rocks Collection';
...
$config['skylight_filters'] = array('Creator'=> 'dc.creator', 'Keyword' => 'dc.subject', 'Type' => 'dc.type');
