...
$config['skylight_url_prefixes'] = array('mimed', 'art', 'calendars', 'iconics', 'obooks', 'anatomy', 'cockburn', 'exhibitions');
...
$config['skylight_handle_prefix'] = '123456789';
...
$config['skylight_objectproxy_url'] = 'http://localhost:8081/bitstream/123456789/';
