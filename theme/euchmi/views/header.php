...
<!--[if (gte IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>St Cecilia's Hall Music Instruments Images</title>
    ...
    <body>
        ...
        <div id="container">
            <header>
                <p class="collection-title"><img src = "<?php echo base_url(); ?>theme/<?php echo $this->config->item('skylight_theme'); ?>/images/bg_logo.jpg"></p>
