...
if (isset($solr[$internal_uri_field])) {
    foreach($solr[$internal_uri_field] as $internalURI) {
        ...
        echo '<h3 class="collection-link"><a href="'. $internalURI . '" target="_blank">View items in collection</a></h3>';
    }
}
else if (isset($solr[$external_uri_field][0])) {
    foreach($solr[$external_uri_field] as $externalURI) {
        echo '<h3 class="collection-link"><a href="'.$externalURI.'" target="_blank">View items in collection</a></h3>';
    }
}
