...
{ ?>
    <div class="results_header archives_header">
        <div class="col-sm-12 col-xs-12 col-md-8 col-lg-8 results_text">Archive and Manuscript collections contain documentary evidence for understanding
        ...
        <div class="col-sm-12 col-xs-12 col-md-4 col-lg-4 flowplayer" data-analytics="<?php echo $ga_code ?>"
...
<?php } elseif (strpos($search_url, 'Header:%22museums%22') > 0) { ?>
    ...
    <div class="results_header museums_header">
        <div class="col-sm-12 col-xs-12 col-md-8 col-lg-8 results_text">Most collections support scholarly research, some tell the story of the
...
<?php } elseif (strpos($search_url, 'Header:%22rarebooks%22') > 0) { ?>
    ...
    <div class="results_header rare_header">
        <div class="col-sm-12 col-xs-12 col-md-8 col-lg-8 results_text">We have about 400,000 rare books and manuscripts, many found nowhere else. Our
...
<?php } elseif (strpos($search_url, 'Header:%22art%22') > 0) { ?>
    ...
    <div class="results_header art_header">
        <div class="col-sm-12 col-xs-12 col-md-8 col-lg-8 results_text">The Art Collection contains over 5,000 items which reflect the history of the
...
<?php } elseif (strpos($search_url, 'Header:%22mimed%22') > 0) { ?>
    ...
    <div class="results_header mimed_header">
        <div class="col-sm-12 col-xs-12 col-md-8 col-lg-8 results_text">The Musical Instrument Collection contains over 5,500 items, covering the history of
