<?php
        ...
        if (!empty($search_url))
        {
            ...
            elseif (strpos($search_url, 'Header:%22museums%22') > 0)
            {
            ...
            elseif (strpos($search_url, 'Header:%22rarebooks%22') > 0)
            {
            ...
            elseif (strpos($search_url, 'Header:%22art%22') > 0)
            {
            ...
            elseif (strpos($search_url, 'Header:%22mimed%22') > 0)
            {
