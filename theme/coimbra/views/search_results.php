...
<div class="row">
    <div class="col-sm-9 col-xs-12">
        ...
        foreach ($docs as $index => $doc) {
            ...
            <div class="row">
                <div class="col-sm-3 col-xs-4 result-img">
                ...
                <div class="col-xs-8 col-sm-9 result-info">
                    <h4 class="record-title">
                        ...
                        <small>
                            <?php if (isset($doc[$date_field][0])) {
                                echo $doc[$date_field][0];
                            } else {
//                                What does 'unknown' mean to the end-user? Either put hover description or remove -Kristiyan
//                                echo 'Unknown';
                            } ?>
                        </small>
                    </h4>
